  ...
  async onRegister(req, res) {
    try {
      ...
      await transporter.sendMail({
        ...
        subject:
          "ยืนยันการสมัครสมาชิกกับศูนย์เครื่องมือวิทยาศาสตร์และถ่ายทอดเทคโนโลยี", // หัวข้ออีเมล
  ...
  async onResendConfirmEmail(req, res) {
    try {
      ...
      await transporter.sendMail({
        ...
        subject:
          "ยืนยันการสมัครสมาชิก ศูนย์เครื่องมือวิทยาศาสตร์และถ่ายทอดเทคโนโลยี คณะวิทยาศาสตร์ประยุกต์", // หัวข้ออีเมล
        html:
          "<b>ศูนย์เครื่องมือวิทยาศาสตร์และถ่ายทอดเทคโนโลยี คณะวิทยาศาสตร์ประยุกต์</b><br> โปรดยืนยันการสมัครสมาชิก : <a href='" +
          process.env.PATH_CLIENT +
          "confirm-email?id=" +
          itemUpdate.id +
          "&email=" +
  ...
  async onResendResetPassword(req, res) {
    try {
      ...
      await transporter.sendMail({
        ...
        to: itemUpdate.email, // อีเมลผู้รับ สามารถกำหนดได้มากกว่า 1 อีเมล โดยขั้นด้วย ,(Comma)
        subject:
          "ยืนยันการรีเซ็ตรหัสผ่าน ศูนย์เครื่องมือวิทยาศาสตร์และถ่ายทอดเทคโนโลยี คณะวิทยาศาสตร์ประยุกต์", // หัวข้ออีเมล
        html:
          "<b>ศูนย์เครื่องมือวิทยาศาสตร์และถ่ายทอดเทคโนโลยี คณะวิทยาศาสตร์ประยุกต์</b><br> โปรดรีเซ็ตรหัสผ่าน : <a href='" +
          process.env.PATH_CLIENT +
          "reset-password?id=" +
          itemUpdate.id +
          "&email=" +
